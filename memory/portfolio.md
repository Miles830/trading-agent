...
## Last Updated
**2026-05-28 (Thursday) — Mid-Morning (11:00 AM ET / 15:18 UTC).** TRADING DAY. Alpaca API STILL BLOCKED ("Host not in allowlist" — 22nd consecutive blocked session). Mid-Morning routine fired 15:18Z (11:18 AM ET). Market-Open heartbeat MISSING → violation logged + catch-up run. Four mandatory limit bracket GTC order attempts (AMD 9sh $517.56, MU 5sh $909.53, MRVL 8sh $210.00 conditional, PLTR 10sh $135.50) — all HTTP 403. MRVL gap-fill risk confirmed: some sources show $191–$202 intraday range (below pre-earnings close $207); MRVL score updated to 7.67 (was 8.0), technical downgraded to 6, conservative limit $210 (only fills if above pre-earnings close). AMD/MU/PLTR scores unchanged. PCE data released 8:30 AM ET — market reaction not accessible. BTC ~$75,716 (below $82K). GLD only confirmed position; stop $397.92 unverifiable. Binding watchlist for Midday+: MU (8.33, MANDATORY), AMD (7.83, MANDATORY), MRVL (7.67, conditional on price ≥$210), PLTR (7.5, MANDATORY). Cumulative gap vs SPX: ~−4.25 pp.
