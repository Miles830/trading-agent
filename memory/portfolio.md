...
## Last Updated
**2026-06-25 (Thursday) — PRE-MARKET (8:04 AM ET / 12:04 UTC). TRADING DAY. Alpaca API STILL BLOCKED (proxy 403 / HTTP_STATUS:000 — 47th consecutive blocked session). ⭐⭐⭐ OVERNIGHT CATALYST: MU Q3 FY2026 HISTORIC EARNINGS BEAT — Revenue $41.46B vs $34.98B (+18.5%), EPS $25.11 vs $20.81 (+20.8%), Gross Margin 84.9%, Data Center $11.5B (+651% YoY), Q4 Guide $50B vs $42.9B consensus (+16.5% above). MU +17% premarket. S&P 500 futures CLIMBING. PCE data at 8:30 AM ET. Semiconductor sector rally underway. THREE ORDERS APPROVED AND ATTEMPTED — ALL BLOCKED: (1) MU 4sh MOO (8.5 avg, post-earnings blowout); (2) GOOGL 14sh MOO (7.83 avg, Dow inclusion T-4); (3) NVDA 23sh MOO (7.83 avg, AI capex confirmed). INTC DEFERRED to Market-Open limit order (7.5 avg — 3-MOO cap consumed by higher-scoring names). IBM REJECTED (6.5 avg — June 24 bearish reversal from $289 pre-market to $260.37 close). AMD: Pre-existing 9.14% violation persists (18sh stale GTC fills at $506.76 June 23). AMD June 24 close $517.13; pre-market June 25 est. $540-558. KEY PRICES: INTC $133.20 premarket, GOOGL $345.29, BTC $61,285 (below $82K). CUMULATIVE GAP vs SPX: est. ~−4.2 pp (unchanged — still no confirmed positions). OPERATOR URGENT (BEFORE 9:25 AM ET): (1) SELL 9sh AMD at open; (2) MOO 4sh MU; (3) MOO 14sh GOOGL; (4) MOO 23sh NVDA; (5) Market-Open: limit 36sh INTC bracket GTC $133.86 (stop $127.17, target $153.94).**
