...
## Last Updated
**2026-05-28 (Thursday) — Market Open (9:45 AM ET / 13:47 UTC).** TRADING DAY. Alpaca API STILL BLOCKED ("Host not in allowlist" — 22nd consecutive blocked instance). Market-Open routine fired 13:47Z (9:47 AM ET). Market open ~17 minutes. Pre-Market heartbeat confirmed (12:07→12:23Z). PCE inflation data released 8:30 AM ET (in-line expected; market reaction unknown from this runner). Stop-loss audit blocked. MOO fills unverifiable (Pre-Market MOO orders were also blocked). Four limit bracket GTC reattempts — all HTTP 403: AMD 9sh $514.56, MU 5sh $909.55, MRVL 8sh $219.09 (ONLY if ≥$210 intraday), PLTR 10sh $135.50. MRVL gap-fill risk: Pre-Market flagged possible intraday pullback to $191–$202; entry only valid if MRVL ≥$210. Cumulative gap vs SPX: ~−4.25 pp (widening). OPERATOR: execute all 4 manually and confirm GLD stop $397.92 resting.
