...
## Last Updated
**2026-06-24 (Wednesday) — MARKET-OPEN (8:22 AM ET / 12:22 UTC — running 83 min before market open). TRADING DAY. Alpaca API STILL BLOCKED ("Host not in allowlist" — 47th consecutive blocked session). PRICE CORRECTIONS FROM PRE-MARKET ESTIMATES: INTC ~$134 (consistent with estimate). IBM ~$264 (NOT $289 — June 23 close was ~$262.87, not ~$275; JPMorgan upgrade less catalytic than expected). AMD June 23 pre-market CONFIRMED $506.76 (−8.13%) → both stale GTCs filled at ~$506.76 open. 18sh AMD NAKED, $9,121 = 9.13% equity, NO STOPS. AMD June 23 close CONFIRMED $526.60 (+$357 unrealized). MU Q3 FY2026 earnings tonight: consensus $34.66B / $19.95 EPS — EXEMPTION 2 all day. INTC Market-Open re-attempt: 36sh limit $134.70 bracket GTC (stop $127.97, target $154.91) APPROVED 7.17 — BLOCKED HTTP 403 (47th). IBM Market-Open re-attempt: 3sh limit $265.32 bracket GTC (stop $252.05, target $305.12) APPROVED 7.5 — BLOCKED. Cumulative gap vs SPX: est. ~−4.2 pp. JUNE 24 MANDATORY ACTIONS (before 9:30 AM ET): (1) ⚠️⚠️ OPERATOR CRITICAL: Sell 9sh AMD immediately (reduce from 18sh→9sh to get under 5% limit); place GTC stop on remaining 9sh at $481.42 ($506.76×0.95); take-profit $582.77 ($506.76×1.15); (2) OPERATOR: Execute INTC 36sh limit $134.70 bracket GTC (stop $127.97, target $154.91) — APPROVED 7.17; (3) OPERATOR: Execute IBM 3sh limit $265.32 bracket GTC (stop $252.05, target $305.12) — APPROVED 7.5; (4) MU Exemption 2 all day June 24 — score June 25 post-print.**
