...
## Last Updated
**2026-06-24 (Wednesday) — MARKET-OPEN SCHEDULED (9:45 AM ET / 13:45 UTC). TRADING DAY. Alpaca API STILL BLOCKED ("Host not in allowlist" — 48th consecutive blocked session). Market has been open ~15 min. Three Market-Open order attempts today (12:05Z Pre-Market, 12:22Z first Market-Open, 13:45Z scheduled Market-Open) — ALL BLOCKED HTTP 403. INTC: 36sh limit $134.70 bracket GTC (stop $127.97, target $154.91) APPROVED 7.17 avg — 3× BLOCKED. IBM: 3sh limit $265.32 bracket GTC (stop $252.05, target $305.12) APPROVED 7.5 avg — 3× BLOCKED. AMD 18sh NAKED (stale GTC fills ~$506.76 June 23 = 9.13% equity, NO STOPS — guardrail violation). MU: Exemption 2 all day (earnings tonight ~4:30 PM ET). NVDA: score ~6.5, below threshold. Cumulative gap vs SPX: est. ~−4.2 pp. JUNE 24 MANDATORY OPERATOR ACTIONS (URGENT — market open NOW): (1) ⚠️⚠️ SELL 9sh AMD at market (reduce 18sh→9sh to get under 5% limit); place GTC stop on remaining 9sh at $481.42; take-profit $582.77; (2) BUY 36sh INTC limit $134.70 bracket GTC (stop $127.97, target $154.91); (3) BUY 3sh IBM limit $265.32 bracket GTC (stop $252.05, target $305.12); (4) MU — skip all day June 24; score June 25 Pre-Market post-print.**
