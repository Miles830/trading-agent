...
## Last Updated
**2026-05-27 (Wednesday) — Mid-Morning (11:00 AM ET / 15:11 UTC).** TRADING DAY. Alpaca API STILL BLOCKED ("Host not in allowlist" — 20th+ consecutive blocked session). Pre-Market and Market-Open both silently failed. Mid-Morning running catch-up. Market: S&P 500 ~flat (+0.05%), Nasdaq ~flat (−0.07%), SMH semis ETF +0.90%. MU +5.5% continuing to ~$962.50 (ATH continuation after UBS $1,625 PT upgrade). AMD +3.7% to ~$512 (new ATH continuation). PLTR −1.6% to ~$134.72 (at support). MRVL ~$208-$217 (earnings tonight AH — Exemption 2 applies). GLD ~$415-$418 (flat, stop $397.92 safe). Three MANDATORY orders attempted via curl — all HTTP 403. **OPERATOR MUST MANUALLY PLACE:** (1) BUY 9sh AMD limit $514.56 GTC bracket, stop $488.83, target $591.74; (2) BUY 5sh MU limit $967.31 GTC bracket, stop $918.94, target $1,112.41; (3) BUY 10sh PLTR limit $135.39 GTC bracket, stop $128.62, target $155.70. ALSO: DELETE stale AMD GTC $449 and PLTR GTC $140.35 first. Portfolio ~$100,179 (GLD only; 97% cash). Cumulative gap vs SPX: worsening.
