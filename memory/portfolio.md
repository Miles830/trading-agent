...
## Last Updated
**2026-06-24 (Wednesday) — MID-MORNING (11:04 AM ET / 15:04 UTC). TRADING DAY. Alpaca API STILL BLOCKED ("Host not in allowlist" — 49th consecutive blocked session). Market has been open ~1h35m. FOUR total order attempts today (Pre-Market 12:05Z, Market-Open 12:22Z, Market-Open 13:45Z, Mid-Morning 15:04Z) — ALL BLOCKED HTTP 403. INTC: 36sh limit $134.70 bracket GTC (stop $127.97, target $154.91) APPROVED 7.17 avg — 4× BLOCKED. IBM: 3sh limit $265.32 bracket GTC (stop $252.05, target $305.12) APPROVED 7.5 avg — 4× BLOCKED. AMD 18sh NAKED (stale GTC fills ~$506.76 June 23 = 9.13% equity, NO STOPS — guardrail violation STILL UNRESOLVED). MU: Exemption 2 all day (earnings tonight ~4:30 PM ET). NVDA: score ~6.5, below threshold. Cumulative gap vs SPX: est. ~−4.2 pp. JUNE 24 MANDATORY OPERATOR ACTIONS (URGENT — market is open NOW, 11 AM ET): (1) ⚠️⚠️ SELL 9sh AMD at market (reduce 18sh→9sh to get under 5% limit); place GTC stop on remaining 9sh at $481.42; take-profit $582.77; (2) BUY 36sh INTC limit $134.70 bracket GTC (stop $127.97, target $154.91) — if INTC above $136, use current_ask×1.005 as limit; (3) BUY 3sh IBM limit $265.32 bracket GTC (stop $252.05, target $305.12); (4) MU — skip all day June 24; score June 25 Pre-Market post-print.**
